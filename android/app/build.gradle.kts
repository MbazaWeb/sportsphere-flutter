...
// Enable Google Services (FCM push) only when the config file is present.
...
android {
    ...
    defaultConfig {
        ...
        ndk {
            // Build only the two most common ABIs — halves linker memory
    ...
    // ── Reduce peak dex memory on low-RAM machines ─────────────────────────
    packaging {
        resources {
            excludes += setOf(
