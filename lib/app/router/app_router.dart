...
class RouteTransitions {
  ...
  static CustomTransitionPage<void> fade(Key key, Widget child) {
  ...
  static CustomTransitionPage<void> slideUp(Key key, Widget child) {
    return CustomTransitionPage<void>(
      key: key,
      child: child,
      transitionDuration: duration,
  ...
  static CustomTransitionPage<void> slideRight(Key key, Widget child) {
    return CustomTransitionPage<void>(
      key: key,
      child: child,
      transitionDuration: duration,
...
String? _redirectLogic(Ref<GoRouter> ref, GoRouterState state) {
