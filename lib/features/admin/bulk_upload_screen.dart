...
<<<<<<< HEAD
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          if (_result != null) Text(_result!,
              style: TextStyle(color: _result!.startsWith('Error') ? SportSphereColors.danger : SportSphereColors.sportGreen)),
          const SizedBox(height: 8),
...
<<<<<<< HEAD
  Future<void> _upload() async {
    ...
    try {
      ...
      if (lines.length < 2) throw Exception('Need header row + data rows');
      ...
      setState(() { _result = 'Uploaded $count records successfully'; _uploading = false; });
    } catch (e) {
      setState(() { _result = 'Error: $e'; _uploading = false; });
    }
=======
