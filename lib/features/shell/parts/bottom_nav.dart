          ...
          child: BackdropFilter(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(30),
                border:
                    Border.all(color: SportSphereColors.white.withValues(alpha: 0.12)),
                boxShadow: [
                  BoxShadow(
                    color: SportSphereColors.black.withValues(alpha: 0.45),
                    blurRadius: 28,
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                child: const Row(
                  ...
                  children: [
                    Icon(Icons.login_rounded, color: SportSphereColors.white, size: 18),
                    SizedBox(width: 7),
                    Text(
                      'Log In',
                      style: TextStyle(
